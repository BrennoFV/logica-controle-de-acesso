import { Renderer, Program, Mesh, Triangle, Vec2 } from 'https://unpkg.com/ogl@0.0.106/src/index.mjs';
...
const fragment = `
    ...
    void main(){
        ...
        // CORREÇÃO: Aumentei o brilho e limitei o estouro
        col.rgb *= 0.6;
        col.rgb = clamp(col.rgb, 0.0, 0.8);
...
function update() {
    ...
    program.uniforms.uTime.value = time * config.speed;
